    ...
    <section class="m-2">
        ...
        <div class="table-container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-3">Master Guru</h5>

                <a type="button ms-auto" class="btn btn-primary btn-sm" id="addData">Tambah Guru
                </a>
            ...
            <table class="table table-striped table-bordered ">
                ...
                @empty
                    <tr>
                        <td class="text-center" colspan="6">Tidak ada data guru</td>
                    </tr>
                @endforelse
                </tbody>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel2">Form Guru</h5>
